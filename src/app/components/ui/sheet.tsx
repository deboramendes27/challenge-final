...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      // CORREÇÃO: Z-Index 50 (Fica atrás da janela)
...
const sheetVariants = cva(
  // CORREÇÃO: Z-Index 100 (Fica NA FRENTE do Overlay) e bg-white obrigatório
  "fixed z-[100] gap-4 bg-white p-6 shadow-2xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
